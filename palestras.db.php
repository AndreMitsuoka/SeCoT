<?php
	...
	*/
	...
	$palestras['projeto-domus']['palestrante'] = "Dr. Ricardo C. L. F. Oliveira";
	$palestras['projeto-domus']['biografia']   = "Ricardo Oliveira é professor da Faculdade de Engenharia Elétrica e de Computação (FEEC) da UNICAMP desde 2010. Formou-se em engenharia da computação na PUC-PR (2000), fez mestrado (2003), doutorado (2006) e pós-doutorado (2009) na FEEC-UNICAMP. Suas pesquisas são voltadas para o desenvolvimento de ferramentas numéricas para análise, controle e simulação de sistemas dinâmicos. Atualmente, é vice-coordenador do Departamento de Telemática e bolsista de produtividade em pesquisa do CNPq.";

	$palestras['recuperacao-de-informacao-visual']['titulo']      = "Recuperação de Informação Visual";
